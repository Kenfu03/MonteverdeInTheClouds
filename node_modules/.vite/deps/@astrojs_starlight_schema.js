...
var badgeSchema = () => z4.object({
  ...
  text: z4.string(),
  class: z4.string().optional()
});
var BadgeComponentSchema = badgeSchema().extend({
  size: z4.enum(["small", "medium", "large"]).default("small")
}).passthrough();
...
function starlightI18nSchema() {
  return z7.object({
    ...
    "builtWithStarlight.label": z7.string().describe(
